...
|3|During Week 3, the team completed most of the Checkpoint 3 work. We selected and described defensive controls for the highest-risk issues from the baseline analysis, including role-based access control, retrieval scoping, DLP filtering, prompt injection filtering, audit logging, log integrity, human review, and shadow AI reduction.We also created evidence of defensive work, including filtering logic, validation workflow, access-control design, policy enforcement mapping, logging design, secure prompt templates, guardrail design, retrieval hardening, a least-privilege matrix, and review checklists. By the end of the week, the project had stronger documentation connecting the original risks to realistic defensive improvements. Remaining work includes completing validation evidence, updating the risk register, and preparing the final report and presentation.|
|4|Completed the final checkpoint package. Finalized the report PDF, slide deck, evidence appendix, validation summary, final recommendations, and repository organization. Added the residual risk discussion to the final validation summary so the results, remaining risks, and unresolved issues are documented together. |
